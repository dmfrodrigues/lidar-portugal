...
- `gdal` library and its development headers.
- `libtiff` library and its development headers.
...
- [libtiff](http://www.simplesystems.org/libtiff/): a library for reading and writing TIFF files.
    - Used to read the original LiDAR data tiles (formatted as TIFF) and to generate intermediate TIFF tiles in memory from which the PNG tiles are generated.
